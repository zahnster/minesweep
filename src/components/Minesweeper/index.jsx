...
class Minesweeper extends Component {
  ...
  componentDidMount() {
    document
      ...
      .addEventListener("click", (event) => {
        if (
          event.target.classList.contains("minesweeper-cell") &&
          this.state.gameStatus === HAPPY_GAME
        ) {
  ...
  render() {
    ...
    const startOverButton =
      status === SAD_GAME || status === COMPLETE_GAME ? (
        <button className="start-over" onClick={this.reset}>
          Start Over?
        </button>
      ) : null;
